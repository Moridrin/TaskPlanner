...
public class ConnectionSettingsPanel extends javax.swing.JPanel {
	...
	mysql.MySQL conn = new mysql.MySQL(jTextFieldServer.getText(), Integer.parseInt(jTextFieldPort.getText()), jTextFieldDatabase.getText(),jTextFieldUsername.getText(),jTextFieldPassword.getText());
	conn.setSQL("SELECT * FROM USERS;", new ArrayList<String>());
